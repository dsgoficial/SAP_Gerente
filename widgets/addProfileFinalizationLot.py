...
class AddProfileFinalizationLot(InputDialogV2):

    def __init__(self, sap, selected, parent=None):
        super(AddProfileFinalizationLot, self).__init__(parent=parent)
        self.sap = sap
    ...
    def on_okBtn_clicked(self):
        ...
        try:
            self.sap.createProfileFinalization(self.getData())
