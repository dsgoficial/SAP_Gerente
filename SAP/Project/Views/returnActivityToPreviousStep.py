...
class ReturnActivityToPreviousStep(QtWidgets.QWidget):
    ...
    def __init__(self, iface):
        super(ReturnActivityToPreviousStep, self).__init__()
        self.iface = iface
    ...
    def validate_input(self):
        if self.activity_id_le.text() and self.user_flag_ckb.isChecked():
            self.run.emit()
        else:
