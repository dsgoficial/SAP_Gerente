...
from Ferramentas_Gerencia.sap.interfaces.IManagementDockBuilder import IManagementDockBuilder

from Ferramentas_Gerencia.sap.dock.managementDock import ManagementDock
