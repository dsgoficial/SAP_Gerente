...
from Ferramentas_Gerencia.sap.views.dock.interfaces.IManagementDockBuilder import IManagementDockBuilder

from Ferramentas_Gerencia.sap.views.dock.managementDock import ManagementDock
